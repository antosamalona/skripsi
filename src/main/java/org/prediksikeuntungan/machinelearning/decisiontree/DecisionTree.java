package org.prediksikeuntungan.machinelearning.decisiontree;
...
import org.prediksikeuntungan.machinelearning.decisiontree.impurity.GiniIndexImpurityCalculation;
import org.prediksikeuntungan.machinelearning.decisiontree.impurity.ImpurityCalculationMethod;
import org.prediksikeuntungan.machinelearning.decisiontree.label.Label;
    ...
    protected Feature findBestSplitFeature(List<DataSample> data, List<Feature> features) {
        ...
        for (Feature feature : features) {
            ...
            double calculatedSplitImpurity = splitData.parallelStream().filter(list -> !list.isEmpty()).mapToDouble(
                    list -> impurityCalculationMethod.calculateImpurity(list)).average().getAsDouble();
